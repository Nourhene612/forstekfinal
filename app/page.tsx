...
export default function Home() {
  return (
    <div className="min-h-screen relative overflow-hidden bg-[#0A0F1E]">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              <Link href="#Fonctionnalités" className="text-gray-300 hover:text-white transition-colors">Fonctionnalités</Link>
              <Link href="#guide d'utilisation" className="text-gray-300 hover:text-white transition-colors">Guide d’utilisation</Link>
              <Link href="#témoignages" className="text-gray-300 hover:text-white transition-colors">Témoignages</Link>
              <Link href="#créer votre compte" className="text-gray-300 hover:text-white transition-colors">créer votre compte</Link>
            </div>
      ...
      <section id="guide d'utilisation" className="max-w-7xl mx-auto px-6 py-24 relative z-10">
        <div className="text-center mb-16">
      ...
      <section id="témoignages" className="max-w-7xl mx-auto px-6 py-24 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-bold mb-6">
      ...
      {/* CTA Section */}
      <section id="créer votre compte" className="py-24 relative">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                <li className="hover:text-white transition-colors"> GSM:+21620655028</li>
          ...
          <div className="border-t border-white/10 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-gray-400 text-sm">
                &copy; 2025 Forstek. Tous droits réservés.
              </p>
